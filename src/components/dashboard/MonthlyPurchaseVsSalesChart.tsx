    ...
    <div className="h-[300px] w-full">
      <ChartContainer config={config}>
        <BarChart data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          ...
          />
          <Legend />
          <Bar dataKey="purchases" name="Purchases" fill="var(--color-purchases)" barSize={30} radius={[4, 4, 0, 0]} />
          <Bar dataKey="sales" name="Sales" fill="var(--color-sales)" barSize={30} radius={[4, 4, 0, 0]} />
        </BarChart>
      </ChartContainer>
    </div>
  );
